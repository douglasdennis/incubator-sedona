  ...
  def isElementTypeWithGeo(repeatedType: Type, parentName: String): Boolean = {
    {
      ...
      //    }
      //
      repeatedType.getName == arrayName
    } || {
    ...
    field.dataType match {
      ...
      case ArrayType(elementType, nullable @ true) if writeLegacyParquetFormat =>
        ...
        Types
          ...
          .addField(Types
            ...
            .addField(convertField(StructField(arrayName, elementType, nullable)))
            .named("bag"))
          .named(field.name)
      ...
      case ArrayType(elementType, nullable @ false) if writeLegacyParquetFormat =>
        ...
        Types
          ...
          .addField(convertField(StructField(arrayName, elementType, nullable), REPEATED))
          .named(field.name)
